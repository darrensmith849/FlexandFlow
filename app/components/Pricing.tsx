...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Works out to R45 per session",
      "WhatsApp class reminders",
      "Ideal for once-a-week consistency",
    ],
    launchNote: "First month: R144 with launch discount",
  ...
  },
  {
    ...
    features: [
      ...
      "Works out to under R44 per session",
      "WhatsApp class reminders",
      "Best for consistent progress",
    ],
    launchNote: "First month: R280 with launch discount",
